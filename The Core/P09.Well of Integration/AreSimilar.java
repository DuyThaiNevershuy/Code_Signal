public class AreSimilar {
    boolean solution(int[] a, int[] b) {
        ...
        for (int i =0;i<a.length;i++){
            ...
            if (count ==0) return true; // count =0--> ko có cặp số nào khác nhau, luôn đúng
            if (count ==1) return false;
            if (count ==2) return (a1==b2 && a2==b1);
                 // nếu như có 2 cặp số khác nhau mà 2 cặp số ấy hoán đổi vị trí mà bằng nhau thì đúng, count ==1 thì sai
